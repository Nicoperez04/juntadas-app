/**
 * Dataset del juego Preguntas para el grupo — 100 preguntas icebreaker
 * agrupadas conceptualmente en cinco bloques temáticos.
 */
export const GROUP_QUESTIONS: readonly string[] = [
  // ¿Quién del grupo...?
...
/**
 * Baraja un array con Fisher-Yates y retorna una copia nueva.
 */
...
/**
 * Retorna las 100 preguntas del juego en orden aleatorio.
 * Al agotar el mazo en pantalla, volver a llamar esta función para re-barajar.
 */
export const getShuffledQuestions = (): string[] => shuffleArray(GROUP_QUESTIONS);
