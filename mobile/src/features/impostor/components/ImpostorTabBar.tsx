/**
 * Tab bar inferior reutilizado en pantallas del flujo Impostor.
 *
 * Replica el patrón visual de MeetupHomeScreen para que la navegación
 * principal siga accesible durante la partida presencial.
 */
...
interface ImpostorTabBarProps {
  /** Tab resaltado — en flujo impostor suele ser 'games' */
  activeTabId?: string;
}

/**
 * Barra de tabs fija al pie, coherente con el home de juntadas.
 *
 * @param activeTabId - ID del tab activo para resaltar ícono y label
 */
